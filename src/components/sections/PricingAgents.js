  ...
  return (
    <section className='pricing-agents light-section' id='pricing' style={{ padding: '10rem 0', background: 'var(--off-white)', borderTop: '1px solid rgba(0,0,0,0.05)' }}>
      <div className='container'>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '4rem', maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div className='pricing-card reveal-up' ref={starterRef} style={{ background: '#fff', padding: '5rem 4rem', borderRadius: '40px', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0 20px 60px rgba(0,0,0,0.04)', display: 'flex', flexDirection: 'column' }}>
            ...
            <ul className='apple-list' style={{ marginBottom: '4rem', display: 'flex', flexDirection: 'column', gap: '1.25rem', flexGrow: 1 }}>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: '#444' }}>Industry templates — live in 5 min</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: '#444' }}>Google, HubSpot, Zoho integrations</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: '#444' }}>WhatsApp & SMS channels built in</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: '#444' }}>Basic analytics dashboard</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: '#444' }}>Standard premium voice library</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: '#444' }}>Full CX Platform included</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: '#444' }}>Email support</li>
            </ul>
          ...
          <div className='pricing-card pricing-card--featured reveal-up' ref={enterpriseRef} style={{ transitionDelay: '0.1s', background: 'linear-gradient(145deg, #0a0e17 0%, #151b2b 100%)', color: '#fff', padding: '5rem 4rem', borderRadius: '40px', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 40px 100px rgba(0,108,210,0.2)', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ fontSize: '2.5rem', fontWeight: '900', marginBottom: '2.5rem', fontFamily: "'Nunito', sans-serif" }}>Enterprise</h3>
            <ul className='apple-list' style={{ marginBottom: '4rem', display: 'flex', flexDirection: 'column', gap: '1.25rem', flexGrow: 1 }}>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: 'rgba(255,255,255,0.9)' }}>Custom conversation design design</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: 'rgba(255,255,255,0.9)' }}>Any CRM/ERP/PMS integration</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: 'rgba(255,255,255,0.9)' }}>Harness AI logic module</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: 'rgba(255,255,255,0.9)' }}>Custom brand voice (cloned)</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: 'rgba(255,255,255,0.9)' }}>Advanced custom analytics</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: 'rgba(255,255,255,0.9)' }}>Dedicated account engineer</li>
              <li style={{ fontWeight: 600, fontSize: '1.1rem', color: 'rgba(255,255,255,0.9)' }}>Priority 24/7 support</li>
            </ul>
